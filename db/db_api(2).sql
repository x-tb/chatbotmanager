...
--
-- Host: localhost
-- Generation Time: Jul 08, 2020 at 01:38 PM
...
--
ALTER TABLE `calon_siswa`
  MODIFY `id_calon` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=398;
...
--
ALTER TABLE `hasil_test_wawancara_ppdb_siswa`
  MODIFY `id_wawancara` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1210;
