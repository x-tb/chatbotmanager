...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2020 at 10:36 AM
...
--
ALTER TABLE `api_kelas`
  MODIFY `idkelas` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `api_penugasan`
  MODIFY `id_penugasan` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `api_presensi_online`
--
ALTER TABLE `api_presensi_online`
  MODIFY `id_presensi_online` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=605;
