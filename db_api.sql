...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2020 at 01:06 PM
...
--
ALTER TABLE `api_penugasan`
  MODIFY `id_penugasan` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `api_presensi_online`
--
ALTER TABLE `api_presensi_online`
  MODIFY `id_presensi_online` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=683;
