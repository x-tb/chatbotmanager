...
(243, 'PPDB2021100224', 'Saputra', 'Laki - laki', 'Dddd', '282882', 'Multimedia', 'Rekayasa Perangkat Lunak', 'SMPIT Pondok Duta', 1);
...
--
ALTER TABLE `calon_siswa`
  MODIFY `id_calon` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=245;
...
--
ALTER TABLE `hasil_test_wawancara_ppdb_siswa`
  MODIFY `id_wawancara` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=663;
