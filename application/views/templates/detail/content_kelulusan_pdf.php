	...
	<table align="center" id="nilaisiswa" border="1" border-style="solid" width="90%">
       ...
       <tr>    
        ...
        <tr>
            ...
            <td class="tengahin"><?php $rata=array($one->n_agama,$one->n_pkn,$one->n_bind,$one->n_mtk,$one->n_sejarah,$one->n_bing,$one->n_sbud,$one->n_penjasor,$one->n_native,$one->n_sunda,$one->n_kjuruan1,$one->n_kjuruan2,$one->n_kjuruan3,$one->n_kjuruan4,$one->n_kjuruan5); $avg=array_sum($rata)/count($rata); echo round($avg); ?></td>
