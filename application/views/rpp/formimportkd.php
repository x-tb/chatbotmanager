...
<div class="container">
    ...
    <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Import Data Kompetensi Dasar</h6>
            </div>
    <div class="card-body">
            <?= $this->session->flashdata('message'); ?>

        
<h2>Format Excel Impot Data Kompetensi Dasar</h2>
    <hr>
    <a href="<?= base_url('assets/samplefile/datasiswaSampleLulus.xlsx') ?>">Download Template File Excel</a>
    <div class="pesan" style="display: none;"></div>
    <?= form_open_multipart('kompetensi/doimportkd', ['class' => 'formimport']) ?>
